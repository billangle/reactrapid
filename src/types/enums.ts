export enum HEADER_BACKGROUND {
  LightPink = "light-pink",
  LightBlue = "light-blue",
  WhiteIsotope = "WhiteIsotope",
  BlackIsotope = "BlackIsotope",
}

export enum CARD_SHADOW_COLOR {
  LightGrey = "#ccc",
  WhightSmoke = "#f5f5f54d",
}

export enum FOOTER_CONTACT_TYPE {
  contactRei = "contactRei",
}
...
export enum PAGE_TITLE {
  ...
  screeningRequests = "Review Screening Requests",
  genericRankTypeSelection = "Ranking",
}
